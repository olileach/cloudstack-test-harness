...
if __name__ == "__main__":
    ...
    addvpnuser = cs_api.request(dict({'command':'addVpnUser', 'username' : 'user9', 'password' : 'djsanjkdasjkldna' }))
    addvpnuser = dotdictify(addvpnuser)
    addvpnuser = addvpnuser.addvpnuserresponse
    print addvpnuser

    asyncjob = None

    for key, value in addvpnuser.items():
    ...
    for k, v in addvpnuser_asyncqry.iteritems():
        print k, v
