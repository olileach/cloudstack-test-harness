...
if __name__ == "__main__":
    ...
    for key, value in enable_nat.items():
        if key == 'success' : natstatus = 'success'
    
    create_staticnatpwrule = cs_api.request(dict({'command' : 'createIpForwardingRule' , 'ipaddressid' : pub_ipid , 'startport' : '22' , \
                                                'endport' : '22' , 'protocol' : 'TCP' }))
