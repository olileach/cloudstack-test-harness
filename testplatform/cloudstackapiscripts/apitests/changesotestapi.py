...
if __name__ == "__main__":
    ...
    print 'THIS IS THE NEW SO', changeso
 
    a = dotdictify(changeso)
    a = a.virtualmachine
    ...
    #for key, value in changeso.iteritems():
    #    if key == 'jobid' : asyncjob = value
    #    print key, value

    #print asyncjob, ' async jobid'

    
    #job = CloudstackAPI()
    #job.asyncresults(asyncjob=value, api_key=api_key, secret_key=secret_key)
    
    #createportfw_asyncqry = job.asyncresults(asyncjob=value, api_key=api_key, secret_key=secret_key)
    #changeso_asyncqry = cs_api.request(dict({'command':'queryAsyncJobResult', 'jobid':asyncjob}))
    #print changeso_asyncqry
    #resetpasswd_asyncqry = dotdictify(changeso_asyncqry)
    #print changeso_asyncqry
    #changeso_asyncqry = changeso_asyncqry.virtualmachine
    #print changeso_asyncqry
